    ...
    <div>
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-[#081618] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-200/10">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl text-transparent font-bold tracking-tight  bg-clip-text bg-gradient-to-r from-yellow-300 to-pink-600 sm:text-6xl">
